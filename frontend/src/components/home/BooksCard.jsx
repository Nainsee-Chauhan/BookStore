      ...
      {books.map((item) => (
        <div 
            ...
            className='border-2  border-gray-500 rounded-lg px-4 py-2 relative hover:shadow-xl'>
                <h2 className='absolute top-1 right-2 px-4 py-1 bg-cyan-500 rounded-lg'>
                    {item.publishYear}
                </h2>
                <h4 className='my-2 text-gray-500'>{item._id}</h4>
                <div className='flex justify-start items-center gap-x-2'>
                    <PiBookOpenTextLight className='text-cyan-500 text-2xl'/>
                    <h2 className='my-1'>{item.title}</h2>
                </div>
                <div className='flex justify-start items-center gap-x-2'>
                    <BiUserCircle className='text-cyan-500 text-2xl'/>
